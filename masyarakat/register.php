...
<head>
    ...
    <title>APPM - Registrasi Masyarakat </title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="crud_web.php?pg=register" method="POST" class="user">
                                        ...
                                        <div class="form-group">
                                            <input type="password" name="password" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Buat Password Anda">
                                        </div>
                                        <div class="form-group">
