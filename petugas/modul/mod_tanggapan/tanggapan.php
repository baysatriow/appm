                ...
                <tr>
                  ...
                  <tr>
                      ...
                      <td>
                          ...
                          <?php if ($row['status'] == 2) {
                          ?>
                          <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalTanggapan<?= $pengaduan['id_pengaduan'] ?>" disabled>
                            <i class="fas fa-edit"> </i>Tanggapi
                          </button>
                          <?php }else{ ?>
                          <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalTanggapan<?= $pengaduan['id_pengaduan'] ?>">
                          <i class="fas fa-edit"> </i>Tanggapi
                          </button>
                          <?php } ?>
                          <!-- Modal -->
